...
#define CH_NME_EDIT_FIELD(z, x, y) NME_EDIT_FIELD(z, false, Constraints::x::##y##_ALLOWED_CHARS, Constraints::x::##y##_MAX_LENGTH);

// Макрос для создания поля ввода с ограничениями и скрытием ввода
#define CH_NME_EDIT_FIELD_H(z, x, y) NME_EDIT_FIELD(z, true, Constraints::x::##y##_ALLOWED_CHARS, Constraints::x::##y##_MAX_LENGTH);
